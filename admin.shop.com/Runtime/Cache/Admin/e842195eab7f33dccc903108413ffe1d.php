...
<head>
	<title>ECSHOP 管理中心 - 商品<?php echo ($meta_supplier); ?> </title>
	...
	<link href="http://admin.shop.net/Public/Admin/css/page.css" rel="stylesheet" type="text/css" />
	<!--预留添加css样式的位置-->
</head>
<body>
<h1>
	<span class="action-span"><a href="<?php echo U('add');?>">添加<?php echo ($meta_supplier); ?></a></span>
	<span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
	<span id="search_id" class="action-span1"> - 商品<?php echo ($meta_supplier); ?> </span>
	<div style="clear:both"></div>
</h1>

<div class="form-div">
	<form action="<?php echo U();?>" name="searchForm" method="get">
		<img src="http://admin.shop.net/Public/Admin/images/icon_search.gif" width="26" height="22" border="0" alt="search" />
...
<td align="center"><a class="ajax-get" href="<?php echo U('changeStatus',array('id'=>$row['id'],'status'=>1-$row['status']));?>"><img src="http://admin.shop.net/Public/Admin/images/<?php echo ($row["status"]); ?>.gif" alt=""/></a></td>
...
<div id="footer">
	共执行 4 个查询，用时 0.024254 秒，Gzip 已禁用，内存占用 2.434 MB<br />
