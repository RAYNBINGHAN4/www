...
<head>
    ...
    <link href="http://admin.shop.net/Public/Admin/uploadify/uploadify.css" rel="stylesheet" type="text/css" />
...
<script type = "text/javascript">
    ...
    <script type="text/javascript" src="http://admin.shop.net/Public/Admin/uploadify/jquery.uploadify.js"></script>
    <script type="text/javascript">
        $("#upload-logo").uploadify({
            height        : 24,    //指定删除插件的高和宽
            width         : 145,
            swf           : 'http://admin.shop.net/Public/Admin/uploadify/uploadify.swf',  //指定swf的地址
