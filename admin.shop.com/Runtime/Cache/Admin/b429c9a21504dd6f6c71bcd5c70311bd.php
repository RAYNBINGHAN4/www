...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="http://admin.shop.com/Public/Admin/images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="javascript:;" target="main-frame"><?php echo ((isset($_SESSION['USER_INFO']['username']) && ($_SESSION['USER_INFO']['username'] !== ""))?($_SESSION['USER_INFO']['username']):'游客'); ?></a></li>
